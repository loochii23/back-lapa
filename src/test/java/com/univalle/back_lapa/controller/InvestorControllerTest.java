...
public class InvestorControllerTest {
    ...
    void greetingShouldReturnDefaultMessage() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/investor-list/2/82c79c039cbf11edab3e16596b766377",
    ...
    void greetingShouldReturnEmptyMessage() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/investor-list/3/82c89c039cbf11edab3e16596b766377",
